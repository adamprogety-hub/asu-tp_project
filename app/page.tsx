...
/* ─── Staggered Animated Logo (Large, Pale, Staggered Parts) ─── */
function StaggeredAcLogo({
  ...
  return (
    <svg
      ...
      style={{
        opacity: 0.26,
        filter: "drop-shadow(0 0 16px rgba(200, 242, 81, 0.45))",
      }}
    >
        ...
        {paths.map((p, idx) => (
          <motion.path
            ...
            transition={{
              ...
              fill: { duration: 0.35, delay: p.delay + p.dur * 0.4 },
            }}
            stroke={p.fill}
            strokeWidth={28}
            strokeLinecap="round"
...
/* ─── Section Preloader (Scroll-Triggered Staggered Logo -> Fade Out) ─── */
function SectionPreloaderOverlay({
  ...
  const bgStyle =
    theme === "light"
      ...
      : "rgba(16, 19, 18, 0.98)";
  const auraGlow =
    theme === "light" ? "rgba(200, 242, 81, 0.4)" : "rgba(200, 242, 81, 0.3)";
      ...
      <AnimatePresence>
        {isInView && !done && (
          ...
          >
            ...
            >
              {/* Pulsing neon glow aura behind large pale logo */}
              <div
                style={{
                  position: "absolute",
                  width: 180,
              ...
              />
              <StaggeredAcLogo size={150} theme={theme} />
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
